...
public class HorizonMeter2Activity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horizon2);
    ...
    private void initView() {
        ...
        mCameraUi = new Camera2Ui(this, textureView);
    }
...
//    }
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, HorizonMeter2Activity.class);
